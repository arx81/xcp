...
mkdir -p /etc/enigma2/e2m3u2bouquet/ && wget -O /home/e2m3u2bouquet.ipk "https://github.com/su1s/e2m3u2bouquet/releases/download/v0.8.2/enigma2-plugin-extensions-e2m3u2bouquet_0.8.2_all.ipk" && chmod 777 /home/e2m3u2bouquet.ipk && opkg install /home/e2m3u2bouquet.ipk  && echo "<config>
  <supplier>
